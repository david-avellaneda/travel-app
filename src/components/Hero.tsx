...
const Hero = () => {
  return (
    <section className='max-container padding-container flex flex-col gap-20 py-11 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        <Image
          ...
          width={50}
          height={50}
          className='absolute left-[-5px] top-[-35px] w-10 md:top-[-30px] lg:w[50px]'
        />
        <h1 className='bold-40 lg:bold-88'>Putuk Truno Camp Area</h1>
